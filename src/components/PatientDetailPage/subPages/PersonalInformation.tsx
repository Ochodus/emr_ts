      ...
      >
        ...
        >
          ...
          >
            ...
            <h2>수집하는 기본 개인정보항목</h2>
            <div> * 이름, 핸드폰 번호 등</div>
            <h2>개인 정보 수집 및 이용목적</h2>
            <div> * 환자의 구분 및 관리를 위한 고유 식별 정도</div>
            <div> * 진료 및 예약 등 서비스 이용안내</div>
            <div> * 진료소식 및 안내사항 전달</div>
            <div> * 본원의 발생하는 소식 및 의료정보 제공</div>
            <div> * 환자 맞춤 최적의 서비스 제공 안내</div>
            <div> * 치료 전, 치료 후 비교사진 제공</div>
            <h2>개인정보의 보유, 이용기간</h2>
            <div>
              {" "}
              * 진료 및 치료를 위한 목적으로 의료법에 준하여 법정기간(5년)
              보관함.
            </div>
            <div> * 정보 제공자가 개인정보 삭제를 요청할 경우 즉시 삭제함.</div>
            <div>
              {" "}
              * 단, 법령의 규정에 의해 보유하도록 한 기간 동안은 보유할 수 있음.
            </div>
            <div>
              {" "}
