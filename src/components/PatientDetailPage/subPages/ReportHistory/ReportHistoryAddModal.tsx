...
const MedicalRecordAddModal = ({ show, isNew, selectedReport: selectedReport, addFunction, handleClose }: ReportAddModalProps) => {
    ...
    const handleAddMedicalRecord = () => {
        console.log(
            isNew ? "add" : ("edit - " + selectedReport?.symptoms),
